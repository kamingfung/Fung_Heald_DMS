module seq_drydep_mod
  ...
  integer, private, parameter :: maxspc = 214              ! Maximum number of species
  integer, public,  parameter :: n_species_table = 196     ! Number of species to work with
  ...
  real(r8), public, parameter :: dfoxd(n_species_table) = &
       ...
       ,1._r8     & ! TERP2OOH
       ,1.e-36_r8 & ! DMS
       ,1.e-36_r8 & ! DMSO; added by fkm for depositions
       ,1.e-36_r8 & ! MSIA; added by fkm for depositions
       ,1.e-36_r8 & ! MSA;  added by fkm for depositions
       ,1.e-36_r8 & ! HOBR; added by fkm for Phase Transfer
       ,1.e-36_r8 & ! H2SO4
       ,1._r8     & ! HONITR
       ,1._r8     & ! MACRN   
       ,1._r8     & ! MVKN
  ...
  character(len=20), public, parameter :: species_name_table(n_species_table) = &
       ...
       ,'TERP2OOH'                       &
       ,'DMS     '                       &
       ,'DMSO    '                       &    ! added by fkm for depositions
       ,'MSIA    '                       &    ! added by fkm for depositions
       ,'MSA     '                       &    ! added by fkm for depositions
       ,'HOBR    '                       &    ! added by fkm for Phase tranfer
       ,'H2SO4   '                       &
       ,'HONITR  '                       &
       ,'MACRN   '                       &
       ,'MVKN    '                       &
  ...
  !--- data for effective Henry's Law coefficient --- fkm: [M atm^-1] https://wiki.ucar.edu/display/camchem/Updating+Gas-Phase+Chemistry
  real(r8), public, parameter :: dheff(n_species_table*6) = &
      (/1.03e-02_r8, 2830._r8,0._r8     ,    0._r8,0._r8     ,    0._r8  & ! OX
       ...
       ,1.e+07_r8,   2580._r8,0._r8     ,    0._r8,0._r8     ,    0._r8  & ! DMSO; added by fkm for Phase Transfer
       ,1.e+08_r8,   1760._r8,10._r8**-2.28_r8    ,    0._r8,0._r8     ,    0._r8  & ! MSIA; added by fkm for Phase Transfer
       ,1.e+09_r8,   1760._r8,10._r8**1.86_r8     ,    0._r8,0._r8     ,    0._r8  & ! MSA;  added by fkm for Phase Transfer
       ,6.1e3_r8,    6014._r8,0._r8     ,    0._r8,0._r8     ,    0._r8  & ! HOBr; added by fkm for Phase Transfer
  ...
  real(r8), private, parameter :: mol_wgts(n_species_table) = &
       ...
       62.1324_r8,                                                                & ! DMS
       78.13_r8, 80.11_r8, 96.10_r8, 96.91_r8,                                    & ! fkm: DMSO, MSIA, MSA, HOBr for Phase Tranfser
       98.0784_r8,    135.118733_r8, 149.102257_r8, 149.102257_r8,                & ! starting from H2SO4
  ...
  subroutine set_hcoeff_vector( ncol, sfc_temp, heff )
    ...
    do m = 1,n_drydep
       ...
       if( dheff(id+5) /= 0._r8 ) then
          ...
          if( trim( drydep_list(m) ) == 'CO2' .or. trim( drydep_list(m) ) == 'NH3' .or. trim( drydep_list(m) ) == 'SO2' .or. trim( drydep_list(m) ) == 'MSIA' .or. trim( drydep_list(m) ) == 'MSA' ) then   ! fkm for deposition
             e298 = dheff(id+3)
             dhr  = dheff(id+4)
             dk1s(:) = e298*exp( dhr*wrk(:) )
             e298 = dheff(id+5)
             ...
             if( trim(drydep_list(m)) == 'CO2'.or. trim( drydep_list(m) ) == 'SO2' .or. trim( drydep_list(m) ) == 'MSIA' .or. trim( drydep_list(m) ) == 'MSA' ) then    ! fkm for deposition
