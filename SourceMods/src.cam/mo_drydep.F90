...
!LKE (7/30/2015): added new TS1 species (phenooh, iepox, noa, etc.)
  ...
  integer :: OOCH2SCH2OOH_ndx, HPMTF_ndx, HOOCH2SCH2O_ndx, HOOCH2S_ndx, HOOCH2SCH2OOH_ndx, HOOCH2SCO_ndx, HOOCH2SO_ndx   ! added by fkm for iso pathway
  logical :: OOCH2SCH2OOH_dd, HPMTF_dd, HOOCH2SCH2O_dd, HOOCH2S_dd, HOOCH2SCH2OOH_dd, HOOCH2SCO_dd, HOOCH2SO_dd   ! added by fkm for iso pathway
...
!Additional drydep RHS
  integer :: bcary_ndx, benzene_ndx, bepomuc_ndx, bigald_ndx, bigald1_ndx, bigald2_ndx, bigald3_ndx
  integer :: bigald4_ndx, bigalk_ndx, bigene_ndx, bzald_ndx, c2h2_ndx, c2h4_ndx, c2h6_ndx, c3h6_ndx
  integer :: c3h8_ndx, cresol_ndx, dms_ndx, glyoxal_ndx, isop_ndx, macr_ndx, mek_ndx, mterp_ndx
  integer :: mvk_ndx, n2o5_ndx, pbznit_ndx, phenol_ndx, tepomuc_ndx, toluene_ndx, xylenes_ndx, xylol_ndx

  logical :: bcary_dd, benzene_dd, bepomuc_dd, bigald_dd, bigald1_dd, bigald2_dd, bigald3_dd
  logical :: bigald4_dd, bigalk_dd, bigene_dd, bzald_dd, c2h2_dd, c2h4_dd, c2h6_dd, c3h6_dd
  logical :: c3h8_dd, cresol_dd, dms_dd, glyoxal_dd, isop_dd, macr_dd, mek_dd, mterp_dd
  logical :: mvk_dd, n2o5_dd, pbznit_dd, phenol_dd, tepomuc_dd, toluene_dd, xylenes_dd, xylol_dd

  integer :: macrn_ndx, mvkn_ndx, isopn2b_ndx, isopn3b_ndx, isopn4d_ndx, isopn1d_ndx, isopnoohd_ndx
  integer :: isopnoohb_ndx, isopnbno3_ndx, no3ch2cho_ndx, hyperacet_ndx, hcoch2ooh_ndx
  integer :: dhpmpal_ndx, mvkooh_ndx, isopoh_ndx, isopfdn_ndx, isopfnp_ndx, hmhp_ndx
  integer :: inheb_ndx, inhed_ndx, hpald1_ndx, hpald4_ndx, isophfp_ndx
  integer :: hpaldb1c_ndx, hpaldb4c_ndx, iche_ndx, isopfdnc_ndx, isopfnc_ndx

  logical :: macrn_dd, mvkn_dd, isopn2b_dd, isopn3b_dd, isopn4d_dd, isopn1d_dd, isopnoohd_dd
  logical :: isopnoohb_dd, isopnbno3_dd, no3ch2cho_dd, hyperacet_dd, hcoch2ooh_dd
  logical :: dhpmpal_dd, mvkooh_dd, isopoh_dd, isopfdn_dd, isopfnp_dd, hmhp_dd
  logical :: inheb_dd, inhed_dd, hpald1_dd, hpald4_dd, isophfp_dd
  logical :: hpaldb1c_dd, hpaldb4c_dd, iche_dd, isopfdnc_dd, isopfnc_dd

  integer :: terpnt_ndx, terpns_ndx, terpnt1_ndx, terpns1_ndx, terpnpt_ndx, terpnps_ndx, terpnpt1_ndx
  integer :: terpnps1_ndx, terpfdn_ndx, sqtn_ndx, terphfn_ndx, terp1ooh_ndx
  integer :: terpdhdp_ndx, terpf2_ndx, terpf1_ndx, terpa_ndx, terpa2_ndx, terpk_ndx, terpapan_ndx
  integer :: terpacid_ndx, terpa2pan_ndx, terp2aooh_ndx
  integer :: terpacid2_ndx, terpacid3_ndx, terpa3pan_ndx, terpoohl_ndx, terpa3_ndx

  logical :: terpnt_dd, terpns_dd, terpnt1_dd, terpns1_dd, terpnpt_dd, terpnps_dd, terpnpt1_dd
  logical :: terpnps1_dd, terpfdn_dd, sqtn_dd, terphfn_dd, terp1ooh_dd
  logical :: terpdhdp_dd, terpf2_dd, terpf1_dd, terpa_dd, terpa2_dd, terpk_dd, terpapan_dd
  logical :: terpacid_dd, terpa2pan_dd, terp2aooh_dd
  logical :: terpacid2_dd, terpacid3_dd, terpa3pan_dd, terpoohl_dd, terpa3_dd
...
contains
  ...
  subroutine dvel_inti_xactive( depvel_lnd_file, clim_soilw_file, season_wes_file )
    ...
    ! so2_dms_ndx = get_spc_ndx( 'SO2_DMS' ) ! added by fkm for SO2 tagging

    dmso_ndx    = get_spc_ndx('DMSO')   ! added by fkm for deposition
    msia_ndx    = get_spc_ndx('MSIA')   ! added by fkm for deposition
    msa_ndx     = get_spc_ndx('MSA')    ! added by fkm for deposition
    ...
    CH3S_ndx      = get_spc_ndx('CH3S')
    CH3SO_ndx     = get_spc_ndx('CH3SO') 
    CH3SOO_ndx    = get_spc_ndx('CH3SOO')
    CH3SO2_ndx    = get_spc_ndx('CH3SO2')
    CH3SO3_ndx    = get_spc_ndx('CH3SO3')
    
    CH3SCH2OO_dd = has_drydep('CH3SCH2OO')
    CH3SCH2O_dd  = has_drydep('CH3SCH2O')
    CH3S_dd      = has_drydep('CH3S')
    CH3SO_dd     = has_drydep('CH3SO') 
    CH3SOO_dd    = has_drydep('CH3SOO')
    CH3SO2_dd    = has_drydep('CH3SO2')
    CH3SO3_dd    = has_drydep('CH3SO3')
    ! ===== [END: added by fkm for H abstraction] =====
    
    ! ===== [BEG: added by fkm for iso pathway] =====
    OOCH2SCH2OOH_ndx    = get_spc_ndx('OOCH2SCH2OOH')
    HPMTF_ndx           = get_spc_ndx('HPMTF')
    HOOCH2SCH2O_ndx     = get_spc_ndx('HOOCH2SCH2O')
    HOOCH2S_ndx         = get_spc_ndx('HOOCH2S')
    HOOCH2SCH2OOH_ndx   = get_spc_ndx('HOOCH2SCH2OOH')
    HOOCH2SCO_ndx       = get_spc_ndx('HOOCH2SCO')
    HOOCH2SO_ndx        = get_spc_ndx('HOOCH2SO')

    OOCH2SCH2OOH_dd     = has_drydep('OOCH2SCH2OOH')
    HPMTF_dd            = has_drydep('HPMTF')
    HOOCH2SCH2O_dd      = has_drydep('HOOCH2SCH2O')
    HOOCH2S_dd          = has_drydep('HOOCH2S')
    HOOCH2SCH2OOH_dd    = has_drydep('HOOCH2SCH2OOH')
    HOOCH2SCO_dd        = has_drydep('HOOCH2SCO')
    HOOCH2SO_dd         = has_drydep('HOOCH2SO')
    ! ===== [END: added by fkm for iso pathway] =====
...
! Add more RHS
    bcary_ndx    = get_spc_ndx( 'BCARY')
    benzene_ndx  = get_spc_ndx( 'BENZENE')
    bepomuc_ndx  = get_spc_ndx( 'BEPOMUC')
    bigald_ndx   = get_spc_ndx( 'BIGALD')
    bigald1_ndx  = get_spc_ndx( 'BIGALD1')
    bigald2_ndx  = get_spc_ndx( 'BIGALD2')
    bigald3_ndx  = get_spc_ndx( 'BIGALD3')
    bigald4_ndx  = get_spc_ndx( 'BIGALD4')
    bigalk_ndx   = get_spc_ndx( 'BIGALK')
    bigene_ndx   = get_spc_ndx( 'BIGENE')
    bzald_ndx    = get_spc_ndx( 'BZALD')
    ...
    cresol_ndx   = get_spc_ndx( 'CRESOL')
    dms_ndx      = get_spc_ndx( 'DMS')
    glyoxal_ndx  = get_spc_ndx( 'GLYOXAL')
    isop_ndx     = get_spc_ndx( 'ISOP')
    macr_ndx     = get_spc_ndx( 'MACR')
    mek_ndx      = get_spc_ndx( 'MEK')
    mterp_ndx    = get_spc_ndx( 'MTERP')
    mvk_ndx      = get_spc_ndx( 'MVK')
    n2o5_ndx     = get_spc_ndx( 'N2O5')
    pbznit_ndx   = get_spc_ndx( 'PBZNIT')
    phenol_ndx   = get_spc_ndx( 'PHENOL')
    tepomuc_ndx  = get_spc_ndx( 'TEPOMUC')
    toluene_ndx  = get_spc_ndx( 'TOLUENE')
    xylenes_ndx  = get_spc_ndx( 'XYLENES')
    xylol_ndx    = get_spc_ndx( 'XYLOL')
    bcary_dd     = has_drydep( 'BCARY')
    benzene_dd   = has_drydep( 'BENZENE')
    bepomuc_dd   = has_drydep( 'BEPOMUC')
    bigald_dd    = has_drydep( 'BIGALD')
    bigald1_dd   = has_drydep( 'BIGALD1')
    bigald2_dd   = has_drydep( 'BIGALD2')
    bigald3_dd   = has_drydep( 'BIGALD3')
    bigald4_dd   = has_drydep( 'BIGALD4')
    bigalk_dd    = has_drydep( 'BIGALK')
    bigene_dd    = has_drydep( 'BIGENE')
    bzald_dd     = has_drydep( 'BZALD')
    c2h2_dd      = has_drydep( 'C2H2')
    c2h4_dd      = has_drydep( 'C2H4')
    c2h6_dd      = has_drydep( 'C2H6')
    c3h6_dd      = has_drydep( 'C3H6')
    c3h8_dd      = has_drydep( 'C3H8')
    cresol_dd    = has_drydep( 'CRESOL')
    dms_dd       = has_drydep( 'DMS')
    glyoxal_dd   = has_drydep( 'GLYOXAL')
    h2_dd        = has_drydep( 'H2')
    isop_dd      = has_drydep( 'ISOP')
    macr_dd      = has_drydep( 'MACR')
    mek_dd       = has_drydep( 'MEK')
    mterp_dd     = has_drydep( 'MTERP')
    mvk_dd       = has_drydep( 'MVK')
    n2o5_dd      = has_drydep( 'N2O5')
    pbznit_dd    = has_drydep( 'PBZNIT')
    phenol_dd    = has_drydep( 'PHENOL')
    tepomuc_dd   = has_drydep( 'TEPOMUC')
    toluene_dd   = has_drydep( 'TOLUENE')
    xylenes_dd   = has_drydep( 'XYLENES')
    xylol_dd     = has_drydep( 'XYLOL')
!Becky added these new species
    macrn_ndx     = get_spc_ndx( 'MACRN')
    mvkn_ndx      = get_spc_ndx( 'MVKN')
    isopn2b_ndx   = get_spc_ndx( 'ISOPN2B')
    isopn3b_ndx   = get_spc_ndx( 'ISOPN3B')
    isopn4d_ndx   = get_spc_ndx( 'ISOPN4D')
    isopn1d_ndx   = get_spc_ndx( 'ISOPN1D')
    isopnoohd_ndx = get_spc_ndx( 'ISOPNOOHD')
    isopnoohb_ndx = get_spc_ndx( 'ISOPNOOHB')
    isopnbno3_ndx = get_spc_ndx( 'ISOPNBNO3')
    no3ch2cho_ndx = get_spc_ndx( 'NO3CH2CHO')
    hyperacet_ndx = get_spc_ndx( 'HYPERACET')
    hcoch2ooh_ndx = get_spc_ndx( 'HCOCH2OOH')
    dhpmpal_ndx   = get_spc_ndx( 'DHPMPAL')
    mvkooh_ndx    = get_spc_ndx( 'MVKOOH')
    isopoh_ndx    = get_spc_ndx( 'ISOPOH')
    isopfdn_ndx   = get_spc_ndx( 'ISOPFDN')
    isopfnp_ndx   = get_spc_ndx( 'ISOPFNP')
    hmhp_ndx      = get_spc_ndx( 'HMHP')
    inheb_ndx     = get_spc_ndx( 'INHEB')
    inhed_ndx     = get_spc_ndx( 'INHED')
    hpald1_ndx    = get_spc_ndx( 'HPALD1')
    hpald4_ndx    = get_spc_ndx( 'HPALD4')
    isophfp_ndx   = get_spc_ndx( 'ISOPHFP')
    hpaldb1c_ndx  = get_spc_ndx( 'HPALDB1C')
    hpaldb4c_ndx  = get_spc_ndx( 'HPALDB4C')
    iche_ndx      = get_spc_ndx( 'ICHE')
    isopfdnc_ndx  = get_spc_ndx( 'ISOPFDNC')
    isopfnc_ndx   = get_spc_ndx( 'ISOPFNC')
    terpnt_ndx    = get_spc_ndx( 'TERPNT')
    terpns_ndx    = get_spc_ndx( 'TERPNS')
    terpnt1_ndx   = get_spc_ndx( 'TERPNT1')
    terpns1_ndx   = get_spc_ndx( 'TERPNS1')
    terpnpt_ndx   = get_spc_ndx( 'TERPNPT')
    terpnps_ndx   = get_spc_ndx( 'TERPNPS')
    terpnpt1_ndx  = get_spc_ndx( 'TERPNPT1')
    terpnps1_ndx  = get_spc_ndx( 'TERPNPS1')
    terpfdn_ndx   = get_spc_ndx( 'TERPFDN')
    sqtn_ndx      = get_spc_ndx( 'SQTN')
    terphfn_ndx   = get_spc_ndx( 'TERPHFN')
    terp1ooh_ndx  = get_spc_ndx( 'TERP1OOH')
    terpdhdp_ndx  = get_spc_ndx( 'TERPDHDP')
    terpf2_ndx    = get_spc_ndx( 'TERPF2')
    terpf1_ndx    = get_spc_ndx( 'TERPF1')
    terpa_ndx     = get_spc_ndx( 'TERPA')
    terpa2_ndx    = get_spc_ndx( 'TERPA2')
    terpk_ndx     = get_spc_ndx( 'TERPK')
    terpapan_ndx  = get_spc_ndx( 'TERPAPAN')
    terpacid_ndx  = get_spc_ndx( 'TERPACID')
    terpa2pan_ndx = get_spc_ndx( 'TERPA2PAN')
    terpacid2_ndx = get_spc_ndx( 'TERPACID2')
    terpacid3_ndx = get_spc_ndx( 'TERPACID3')
    terpa3pan_ndx = get_spc_ndx( 'TERPA3PAN')
    terpoohl_ndx  = get_spc_ndx( 'TERPOOHL')
    terpa3_ndx    = get_spc_ndx( 'TERP3')
    terp2aooh_ndx = get_spc_ndx( 'TERP2AOOH')
    macrn_dd      = has_drydep( 'MACRN')
    mvkn_dd       = has_drydep( 'MVKN')
    isopn2b_dd    = has_drydep( 'ISOPN2B')
    isopn3b_dd    = has_drydep( 'ISOPN3B')
    isopn4d_dd    = has_drydep( 'ISOPN4D')
    isopn1d_dd    = has_drydep( 'ISOPN1D')
    isopnoohd_dd  = has_drydep( 'ISOPNOOHD')
    isopnoohb_dd  = has_drydep( 'ISOPNOOHB')
    isopnbno3_dd  = has_drydep( 'ISOPNBNO3')
    no3ch2cho_dd  = has_drydep( 'NO3CH2CHO')
    hyperacet_dd  = has_drydep( 'HYPERACET')
    hcoch2ooh_dd  = has_drydep( 'HCOCH2OOH')
    dhpmpal_dd    = has_drydep( 'DHPMPAL')
    mvkooh_dd     = has_drydep( 'MVKOOH')
    isopoh_dd     = has_drydep( 'ISOPOH')
    isopfdn_dd    = has_drydep( 'ISOPFDN')
    isopfnp_dd    = has_drydep( 'ISOPFNP')
    hmhp_dd       = has_drydep( 'HMHP')
    inheb_dd      = has_drydep( 'INHEB')
    inhed_dd      = has_drydep( 'INHED')
    hpald1_dd     = has_drydep( 'HPALD1')
    hpald4_dd     = has_drydep( 'HPALD4')
    isophfp_dd    = has_drydep( 'ISOPHFP')
    hpaldb1c_dd   = has_drydep( 'HPALDB1C')
    hpaldb4c_dd   = has_drydep( 'HPALDB4C')
    iche_dd       = has_drydep( 'ICHE')
    isopfdnc_dd   = has_drydep( 'ISOPFDNC')
    isopfnc_dd    = has_drydep( 'ISOPFNC')
    terpnt_dd     = has_drydep( 'TERPNT')
    terpns_dd     = has_drydep( 'TERPNS')
    terpnt1_dd    = has_drydep( 'TERPNT1')
    terpns1_dd    = has_drydep( 'TERPNS1')
    terpnpt_dd    = has_drydep( 'TERPNPT')
    terpnps_dd    = has_drydep( 'TERPNPS')
    terpnpt1_dd   = has_drydep( 'TERPNPT1')
    terpnps1_dd   = has_drydep( 'TERPNPS1')
    terpfdn_dd    = has_drydep( 'TERPFDN')
    sqtn_dd       = has_drydep( 'SQTN')
    terphfn_dd    = has_drydep( 'TERPHFN')
    terp1ooh_dd   = has_drydep( 'TERP1OOH')
    terpdhdp_dd   = has_drydep( 'TERPDHDP')
    terpf2_dd     = has_drydep( 'TERPF2')
    terpf1_dd     = has_drydep( 'TERPF1')
    terpa_dd      = has_drydep( 'TERPA')
    terpa2_dd     = has_drydep( 'TERPA2')
    terpk_dd      = has_drydep( 'TERPK')
    terpapan_dd   = has_drydep( 'TERPAPAN')
    terpacid_dd   = has_drydep( 'TERPACID')
    terpa2pan_dd  = has_drydep( 'TERPA2PAN')
    terpacid2_dd  = has_drydep( 'TERPACID2')
    terpacid3_dd  = has_drydep( 'TERPACID3')
    terpa3pan_dd  = has_drydep( 'TERPA3PAN')
    terpoohl_dd   = has_drydep( 'TERPOOHL')
    terpa3_dd     = has_drydep( 'TERPA3')
    terp2aooh_dd  = has_drydep( 'TERP2AOOH')
!
