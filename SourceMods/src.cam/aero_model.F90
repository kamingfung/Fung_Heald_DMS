...
contains
  ...
  subroutine aero_model_init( loffset, pbuf2d )
    ...
    !!! ===== BEG: To save aerosol pH (dsj); fkm for MOSAIC pH
    ...
    call addfld ('hconc_bin1', (/ 'lev' /), 'A', 'unitless', 'H+ concentration (bin1)' )
    call addfld ('hconc_bin2', (/ 'lev' /), 'A', 'unitless', 'H+ concentration (bin2)' )
    call addfld ('hconc_bin3', (/ 'lev' /), 'A', 'unitless', 'H+ concentration (bin3)' )
    call addfld ('hconc_bin4', (/ 'lev' /), 'A', 'unitless', 'H+ concentration (bin4)' )

    call addfld ('n_aerwat_bin1', (/ 'lev' /), 'A', 'unitless', 'aerosol water count (bin1)' )
    call addfld ('n_aerwat_bin2', (/ 'lev' /), 'A', 'unitless', 'aerosol water count (bin2)' )
    call addfld ('n_aerwat_bin3', (/ 'lev' /), 'A', 'unitless', 'aerosol water count (bin3)' )
    call addfld ('n_aerwat_bin4', (/ 'lev' /), 'A', 'unitless', 'aerosol water count (bin4)' )

    call addfld ('n_noaerwat_bin1', (/ 'lev' /), 'A', 'unitless', 'no aerosol water count (bin1)' )
    call addfld ('n_noaerwat_bin2', (/ 'lev' /), 'A', 'unitless', 'no aerosol water count (bin2)' )
    call addfld ('n_noaerwat_bin3', (/ 'lev' /), 'A', 'unitless', 'no aerosol water count (bin3)' )
    call addfld ('n_noaerwat_bin4', (/ 'lev' /), 'A', 'unitless', 'no aerosol water count (bin4)' )

    call addfld ('n_aerosol_ph_bin1', (/ 'lev' /), 'A', 'unitless', 'count for Hconc=0 (bin1)' )
    call addfld ('n_aerosol_ph_bin2', (/ 'lev' /), 'A', 'unitless', 'count for Hconc=0 (bin2)' )
    call addfld ('n_aerosol_ph_bin3', (/ 'lev' /), 'A', 'unitless', 'count for Hconc=0 (bin3)' )
    call addfld ('n_aerosol_ph_bin4', (/ 'lev' /), 'A', 'unitless', 'count for Hconc=0 (bin4)' )
    ...
    call add_default( 'hconc_bin1', 1, ' ' )
    call add_default( 'hconc_bin2', 1, ' ' )
    call add_default( 'hconc_bin3', 1, ' ' )
    call add_default( 'hconc_bin4', 1, ' ' )

    call add_default( 'n_aerwat_bin1', 1, ' ' )
    call add_default( 'n_aerwat_bin2', 1, ' ' )
    call add_default( 'n_aerwat_bin3', 1, ' ' )
    call add_default( 'n_aerwat_bin4', 1, ' ' )

    call add_default( 'n_noaerwat_bin1', 1, ' ' )
    call add_default( 'n_noaerwat_bin2', 1, ' ' )
    call add_default( 'n_noaerwat_bin3', 1, ' ' )
    call add_default( 'n_noaerwat_bin4', 1, ' ' )

    call add_default( 'n_aerosol_ph_bin1', 1, ' ' )
    call add_default( 'n_aerosol_ph_bin2', 1, ' ' )
    call add_default( 'n_aerosol_ph_bin3', 1, ' ' )
    call add_default( 'n_aerosol_ph_bin4', 1, ' ' )
    !!! ===== END: To save aerosol pH (dsj); fkm for MOSAIC pH
    ...
    call add_default( 'qaerwat_bin3', 1, ' ' )
    call add_default( 'qaerwat_bin4', 1, ' ' )
    !!!! ==== END: fkm for MOSAIC alwc_vol_vol
...
!         if (lphase == 1) then
  ...
  subroutine aero_model_gasaerexch( loffset, ncol, lchnk, troplev, delt, reaction_rates, &
    ...
    real(r8), pointer :: qaerwat(:,:,:)  ! aerosol water; fkm for MOSAIC pH
