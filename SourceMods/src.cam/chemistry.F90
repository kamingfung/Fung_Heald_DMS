...
!---------------------------------------------------------------------------------
  ...
  use physics_types,    only : physics_state, physics_ptend, physics_ptend_init, physics_update, physics_state_copy, physics_ptend_sum
...
!================================================================================
  subroutine chem_emissions( state, cam_in )
   ...
   if ( index_x2a_Fall_flxvoc>0 .and. shr_megan_mechcomps_n>0 ) then ! fkm: for OASISS
